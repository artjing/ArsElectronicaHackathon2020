const startButton = document.getElementById('connectButton');
const callButton = document.getElementById('callButton');
const hangupButton = document.getElementById('disconnectButton');
...
const video4 = document.querySelector('video#video3');
const video5 = document.querySelector('video#video3');
...
function call() {
  ...
  console.log('pc2: created local and remote peer connection objects');
   ...
   sendChannel = pc1Local.createDataChannel("sendChannel");
   sendChannel.onopen = handleSendChannelStatusChange;
   sendChannel.onclose = handleSendChannelStatusChange;

   pc1Remote.ondatachannel = receiveChannelCallback;
